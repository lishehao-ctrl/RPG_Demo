...
> If you only want the code, jump to [ARCHITECTURE.en.md](../../ARCHITECTURE.en.md).

> Language: this doc is the English mirror of [2026-05-tiny-stories-9-mechanisms.md](./2026-05-tiny-stories-9-mechanisms.md).
...
[CONTRIBUTING.en.md](../../CONTRIBUTING.en.md) and
[docs/GOOD_FIRST_ISSUES.en.md](../GOOD_FIRST_ISSUES.en.md).
