...
from app.db.models import ActionLog, Session as StorySession, SessionSnapshot, User
from app.main import app
from app.modules.auth.dev_auth import DEFAULT_USER_ID
        ...
        with db.begin():
            ...
            if user is None:
                db.add(
                    User(
                        id=DEFAULT_USER_ID,
                        google_sub=f"dev-{DEFAULT_USER_ID}",
                        email=f"{DEFAULT_USER_ID}@dev.local",
