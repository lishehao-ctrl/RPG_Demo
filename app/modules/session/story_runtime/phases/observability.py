...
def build_layer_debug_payload(
    *,
    ...
    inventory_mutation_count: int,
    npc_mutation_count: int,
    short_memory_compacted_count: int,
    state_json_size_bytes: int,
    prompt_context_npc_count: int,
    llm_retry_count: int,
) -> dict:
    selected_action_id = (
    ...
    return {
        ...
        "selection_latency_ms": max(0, int(selection_latency_ms)),
        "narration_latency_ms": max(0, int(narration_latency_ms)),
        "inventory_mutation_count": max(0, int(inventory_mutation_count)),
        "npc_mutation_count": max(0, int(npc_mutation_count)),
        "short_memory_compacted_count": max(0, int(short_memory_compacted_count)),
        "state_json_size_bytes": max(0, int(state_json_size_bytes)),
        "prompt_context_npc_count": max(0, int(prompt_context_npc_count)),
        "llm_retry_count": max(0, int(llm_retry_count)),
