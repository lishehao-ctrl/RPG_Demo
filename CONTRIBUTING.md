...
4. **Frontend i18n.** All UI strings are hardcoded Chinese. There is
   no string extraction layer. An i18n setup (e.g. `react-intl` or
   plain context-based) would unlock English / other locales.
