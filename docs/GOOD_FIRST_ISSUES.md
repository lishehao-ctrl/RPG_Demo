...
> Languages: **English** · [中文](./GOOD_FIRST_ISSUES.zh.md)
...
**Files:** `ARCHITECTURE.md` + matching `ARCHITECTURE.zh.md`
**Estimated time:** 2h
...
Mermaid diagram is the easiest path. Keep both `.md` and `.zh.md`
