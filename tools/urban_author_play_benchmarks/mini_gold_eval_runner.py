...
DEPRECATION_MESSAGE = (
    "mini_gold_eval_runner 已下线。请改用: "
    "python -m tools.urban_author_play_benchmarks.gold_eval_mini_runner --output-dir <path>"
)


def run_merged_mini_gold_eval(*args, **kwargs):  # noqa: ANN002, ANN003, ANN201
